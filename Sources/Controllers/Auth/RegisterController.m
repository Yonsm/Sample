...
- (void)loadPage
{
	...
	
	{
		...
		[_authButton setBackgroundImage:UIImageWithColor(UIColorWithRGB(0x007aff)) forState:UIControlStateNormal];
		[_authButton setBackgroundImage:UIImageWithColor(UIColorWithRGB(0x209aff)) forState:UIControlStateHighlighted];
